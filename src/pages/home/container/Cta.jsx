...
export default function Cta() {
  return (
    <>
        <svg className='w-full h-auto max-40 translate-y-[5px]' preserveAspectRatio='none' viewBox="0 0 2160 263" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
                <div className='col-span-12 lg:col-span-6'>
                    ...
                    <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg-text-left'>
                        <span className='font-bold italic text-[#b3bac5] md:not-italic md:font-normal md:text-dark-light'>Get a response tomorrow</span>{" "} 
                        if you submit by 9pm today. If we received after 9pm will get a reponse the following day.</p>
                </div>
